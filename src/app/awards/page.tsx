...
export const metadata: Metadata = {
  title: "Trophy Case",
  description:
    "Championships, awards, and superlatives from Greybushes & Chili Dogs league history.",
};
  ...
  return (
    <>
      <PageHeader
        ...
        title="Trophy Case"
        subtitle="Every champion, every record, every distinction earned across 11 seasons."
      />
